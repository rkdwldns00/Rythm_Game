...
public class NoteManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        /*SavedMapData map = new SavedMapData()
        {
            ...
            {
                new SavedMeterChangerNoteData(){beatPerBar=4,whenSummonBeat=0},
                ...
                new SavedBasicNoteData() {startX = 5,endX=7,whenSummonBeat=15},
                new SavedMeterChangerNoteData(){beatPerBar=3,whenSummonBeat=15},
                new SavedMeterChangerNoteData(){beatPerBar=16,whenSummonBeat=16},
                new SavedBasicNoteData() {startX = 9,endX=11,whenSummonBeat=16},
                new SavedBasicNoteData() {startX = 9,endX=11,whenSummonBeat=20},
                new SavedBasicNoteData() {startX = 9,endX=11,whenSummonBeat=24},
                new SavedBasicNoteData() {startX = 9,endX=11,whenSummonBeat=28},
                new SavedBasicNoteData() {startX = 9,endX=11,whenSummonBeat=32},
            }
        };
        ...
        //new NoteSummoner(SUSConveter.Converte("This file was generated by PaletteWorks Editor v1.10.0\r\n#TITLE \"\"\r\n#ARTIST \"\"\r\n#DESIGNER \"\"\r\n#WAVEOFFSET 0\r\n\r\n#REQUEST \"ticks_per_beat 480\"\r\n\r\n#00002:4\r\n#00102:4\r\n#00202:4\r\n#00302:4\r\n#00402:5.333333333333333\r\n\r\n#BPM01:120\r\n#00008:01\r\n#00012:13131313\r\n#00113:131313\r\n#00214:1313\r\n#00315:13"), field, 30).SummmonMap();
    }
